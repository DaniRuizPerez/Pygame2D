...
class EscenaMenu(EscenaPyglet, pyglet.window.Window):
    ...
    def __init__(self, director):
        ...
        # La imagen de fondo
        self.imagen = pyglet.image.load('imagenes/intro-background.png')
        ...
        # Los botones
        self.botonJugar = pyglet.sprite.Sprite(pyglet.image.load('imagenes/startButton.png'))
        self.botonSalir = pyglet.sprite.Sprite(pyglet.image.load('imagenes/exitButton.png'))
