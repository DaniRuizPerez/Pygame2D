...
class Director():
    ...
    def setDificultyLevel (self, dificulty):
        self.dificultyLevel = dificulty

    def getDificultyLevel (self):
        return self.dificultyLevel

    def setDr1n (self, dr1n):
        self.dr1n = dr1n
    ...
    def buclePygame(self, escena):
        ...
        # Juntamos la escena y personaje jugable
        self.dr1n.setStage(escena)
